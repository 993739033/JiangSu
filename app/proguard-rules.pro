...
#-libraryjars libs/GetuiSDK2.9.5.0.jar
...
#    public <methods>;
#}
-dontwarn com.wyw.jiangsu.**
-keep class com.wyw.jiangsu.bus.RefreshBus{ *;}
-keep class com.wyw.jiangsu.runnable.NetClient{*;}
-keep class com.wyw.jiangsu.runnable.download.DownlaodClient{*;}
-keep class com.wyw.jiangsu.utils.CrashHandler{*;}
-keep class com.wyw.jiangsu.utils.FileUtil{*;}
-keep class com.wyw.jiangsu.view.materialsheetfab.animation.RevealAnimator{*;}
-keep class com.wyw.jiangsu.view.materialsheetfab.animation.RevealAnimator$RevealInfo{*;}
-keep class com.wyw.jiangsu.view.materialsheetfab.animation.ViewAnimationUtils{*;}
-keep class com.wyw.jiangsu.view.recyclerview.BaseQuickAdapter{*;}
-keep class com.wyw.jiangsu.view.recyclerview.BaseViewHolder{*;}
