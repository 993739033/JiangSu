...
import com.wyw.jiangsu.adapter.PartPlaceActivityPresenter;
import com.wyw.jiangsu.adapter.PartPlaceBeanAdapter;
...
public class PartPlaceActivity extends MVPActivity<PartPlaceActivityPresenter> implements IBreedingActivity, SpringView.OnFreshListener {
    ...
    private PartPlaceBeanAdapter adapter;
    ...
    @Override
    protected PartPlaceActivityPresenter createPresenter() {
        return new PartPlaceActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("隔离场所监督检查记录列表");
...
//        adapter = new QueryRecylerAdapter(this, getDataa());
        adapter = new PartPlaceBeanAdapter(this, new ArrayList<>(), headerView.getHeaderView());
...
//                bundle.putSerializable(Constance.ACTIVITY_DATA, (Serializable) adapter.getItem(position));
                ...
                bundle.putString("table","Ds_GlcsjcjlS");
