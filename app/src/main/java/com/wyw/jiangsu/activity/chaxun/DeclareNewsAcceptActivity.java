...
import com.wyw.jiangsu.presenter.DeclareNewsAcceptActivityPresenter;
...
/**
 * 申报消息接收查询列表    108  107  是什么意思
 * Created by Administrator on 2017/3/28.
 */
public class DeclareNewsAcceptActivity extends MVPActivity<DeclareNewsAcceptActivityPresenter> implements IDeclareNewsAcceptActivity, SpringView.OnFreshListener {
    ...
    private DeclareNewsAcceptAdapter adapter;
    ...
    @Override
    protected DeclareNewsAcceptActivityPresenter createPresenter() {
        return new DeclareNewsAcceptActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("官方兽医确认");
...
//        adapter = new QueryRecylerAdapter(this, getDataa());
        ...
        adapter = new DeclareNewsAcceptAdapter(this, new ArrayList<>(), headerView.getHeaderView());
    ...
    public void bindListener() {
        ...
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener((recyclerView, position, v) -> {
            if (position != 0) {
                Intent intent = new Intent(this, DeclareNewsAcceptDealActivity.class);
