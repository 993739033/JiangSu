...
public class BreedingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BreedingAdapter(Context context, List<BreedingRecordData.DataListBean> list, View headerView) {
...
*/
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_HEAD.ordinal()) {
            ...
            return new ListviewViewHolder(mLayoutInflater.inflate(R.layout.breeding_adapter, parent, false));
        }
    }
