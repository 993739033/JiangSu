...
import com.wyw.jiangsu.presenter.BreedingActivityPresenter;
...
public class BreedingActivity extends MVPActivity<BreedingActivityPresenter> implements IBreedingActivity, SpringView.OnFreshListener {
    ...
    @Override
    protected BreedingActivityPresenter createPresenter() {
        return new BreedingActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("规模养殖场日常监督检查记录查询列表");
        ...
        adapter = new BreedingAdapter(this, new ArrayList<>(), headerView.getHeaderView());
...
//                bundle.putSerializable(Constance.ACTIVITY_DATA, (Serializable) adapter.getItem(position));
                ...
                bundle.putString("table","Ds_GmyzcjcjlS");
