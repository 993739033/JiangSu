...
import com.wyw.jiangsu.adapter.MedicineHandleAdapter;
import com.wyw.jiangsu.bean.BreedingRecordData;
import com.wyw.jiangsu.presenter.MedicineHandlePresenter;
...
public class MedicineHandleActivity extends MVPActivity<MedicineHandlePresenter> implements IBreedingActivity, SpringView.OnFreshListener {
    ...
    private MedicineHandleAdapter adapter;
    ...
    @Override
    protected MedicineHandlePresenter createPresenter() {
        return new MedicineHandlePresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("兽药经营企业日常检查列表");
        ...
        headerView = new HeadSearchView(this, mRecyclerView, new HeadSearchView.OnSearchListener() {
            ...
            public void onSearch(String strat, String end, String data) {
                ...
                startStr = strat;
                endStr = end;
                getPresenter().getBreedingListData(data, strat, end);
            }
        });
//        adapter = new QueryRecylerAdapter(this, getDataa());
        adapter = new MedicineHandleAdapter(this, new ArrayList<>(), headerView.getHeaderView());
...
//                bundle.putSerializable(Constance.ACTIVITY_DATA, (Serializable) adapter.getItem(position));
                ...
                bundle.putString("table","Ds_SyjyqyjcjlS");
