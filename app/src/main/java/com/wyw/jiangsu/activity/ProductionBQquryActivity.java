...
import com.wyw.jiangsu.activity.chaxun.ProductBBBdapter;
import com.wyw.jiangsu.activity.chaxun.ProductionBQquryDetilActivity;
...
import com.wyw.jiangsu.presenter.ProductionBQquryActivityPresenter;
 ...
 * 产品B查询列表
 */
public class ProductionBQquryActivity extends MVPActivity<ProductionBQquryActivityPresenter> implements IProductionBQquryActivity, SpringView.OnFreshListener {
    ...
    private ProductBBBdapter adapter;
    String value = "";
    String startStr = "";
    String endStr = "";
    String fstid = "";
    ...
    @Override
    protected ProductionBQquryActivityPresenter createPresenter() {
        return new ProductionBQquryActivityPresenter(this);
    }
    ...
    public void bindData() {
        ...
        adapter = new ProductBBBdapter(this, new ArrayList<>(), test.getHeaderView());
    ...
    public void bindListener() {
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener(new RecyclerItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                if (position != 0) {
                    Intent intent = new Intent(ProductionBQquryActivity.this, ProductionBQquryDetilActivity.class);
...
//    @Override
//    public List<ProductBListBean.DataListEntity> getData(List<ProductBListBean.DataListEntity> list) {
//        adapter.setmDatas(list);
//        return list;
//    }

    @Override
    public void addListData(List<ProductBListBean.DataListEntity> list) {
        adapter.addAll(list);
    }

    @Override
    public void setData(List<ProductBListBean.DataListEntity> list) {
        adapter.setmDatas(list);
    }
}
