...
import com.wyw.jiangsu.adapter.HarmlessConcentrateProcessListAdapter;
import com.wyw.jiangsu.bean.HarmlessListBean;
import com.wyw.jiangsu.interfac.Constance;
import com.wyw.jiangsu.interfac.IHarmlessConcentrateProcessListActivity;
import com.wyw.jiangsu.presenter.HarmlessConcentrateProcessListActivityPresenter;
...
/**
 * 无害化集中处理列表
 * 上个页面 无害化处理中心驻场兽医入场确认 {@link HarmlessHomeVeterinarianConfirmActivity}
 * 下个页面 无害化处理中心集中处理任务 {@link HarmlessConcentrateProcessActivity}
 */
public class HarmlessConcentrateProcessListActivity extends MVPActivity<HarmlessConcentrateProcessListActivityPresenter>
        implements IHarmlessConcentrateProcessListActivity, SpringView.OnFreshListener {
    ...
    private HarmlessConcentrateProcessListAdapter adapter;
    @Override
    ...
    @Override
    protected HarmlessConcentrateProcessListActivityPresenter createPresenter() {
        return new HarmlessConcentrateProcessListActivityPresenter(this);
    }
    ...
    public void bindData() {
        setTitle("集中处理");
        adapter = new HarmlessConcentrateProcessListAdapter(new ArrayList<>(),(position, fstId,fclfs) -> {
