...
import com.wyw.jiangsu.activity.chaxun.AnimalAAAdapter;
...
import com.wyw.jiangsu.presenter.AnimAQueryActivityPresenter;
...
public class AnimAQueryActivity extends MVPActivity<AnimAQueryActivityPresenter> implements IAnimAQueryActivity, SpringView.OnFreshListener {
    ...
    private AnimalAAAdapter adapter;
    String value = "";
    String startStr = "";
    String endStr = "";
    String fstid = "";
    ...
    @Override
    protected AnimAQueryActivityPresenter createPresenter() {
        return new AnimAQueryActivityPresenter(this);
    }


    @Override
    public void bindData() {
        tvTitle.setText("动物A查询列表");
        ...
        adapter = new AnimalAAAdapter(this, new ArrayList<>(), headerView.getHeaderView());
    ...
    public void bindListener() {
        ...
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener((recyclerView, position, v) -> {
            if (position != 0) {
                Intent intent = new Intent(this, AnimalAQueryDetilActivity.class);
...
//    @Override
//    public List<AnimAQueryListBean.DataListEntity> getData(List<AnimAQueryListBean.DataListEntity> list) {
//        adapter.setmDatas(list);
//        return list;
//    }

    @Override
    public void addListData(List<AnimAQueryListBean.DataListEntity> list) {
        adapter.addAll(list);
    }

    @Override
    public void setData(List<AnimAQueryListBean.DataListEntity> list) {
        adapter.setmDatas(list);
    }
