...
import com.wyw.jiangsu.adapter.SiliaoProduceActivityAdapter;
import com.wyw.jiangsu.bean.BreedingRecordData;
import com.wyw.jiangsu.interfac.Constance;
import com.wyw.jiangsu.interfac.IBreedingActivity;
import com.wyw.jiangsu.presenter.SiliaoProduceActivityPresenter;
...
public class SiliaoProduceActivity extends MVPActivity<SiliaoProduceActivityPresenter> implements IBreedingActivity, SpringView.OnFreshListener {
    ...
    private SiliaoProduceActivityAdapter adapter;
    ...
    @Override
    protected SiliaoProduceActivityPresenter createPresenter() {
        return new SiliaoProduceActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("饲料生产企业日常检查列表");
...
//        adapter = new QueryRecylerAdapter(this, getDataa());
        adapter = new SiliaoProduceActivityAdapter(this, new ArrayList<>(), headerView.getHeaderView());
...
//                bundle.putSerializable(Constance.ACTIVITY_DATA, (Serializable) adapter.getItem(position));
                ...
                bundle.putString("table","Ds_SlscqyjcjlS");
