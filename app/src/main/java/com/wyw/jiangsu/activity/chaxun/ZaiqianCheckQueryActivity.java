...
import com.wyw.jiangsu.adapter.ZaiqianQueryAdapter;
import com.wyw.jiangsu.interfac.Constance;
import com.wyw.jiangsu.interfac.IZaiqianCheckQueryActivity;
import com.wyw.jiangsu.presenter.ZaiqianCheckQueryActivityPresenter;
 ...
 */
public class ZaiqianCheckQueryActivity extends MVPActivity<ZaiqianCheckQueryActivityPresenter> implements IZaiqianCheckQueryActivity, SpringView.OnFreshListener {
    ...
    private ZaiqianQueryAdapter adapter;
    ...
    @Override
    protected ZaiqianCheckQueryActivityPresenter createPresenter() {
        return new ZaiqianCheckQueryActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("宰前检查查询列表");
        ...
        headerView = new HeadSearchView(this, mRecyclerView, new HeadSearchView.OnSearchListener() {
            ...
            public void onSearch(String strat, String end, String data) {
                ...
                startStr = strat;
                endStr = end;
                getPresenter().getZaiqianCheckData(data, strat, end);
            }
        });
        adapter = new ZaiqianQueryAdapter(this, new ArrayList<>(), headerView.getHeaderView());
    ...
    public void bindListener() {
        ...
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener((recyclerView, position, v) -> {
            if (position != 0) {
                Intent intent = new Intent(this, ZaiqianCheckDeilActivity.class);
...
//    @Override
//    public List<ZaiqianCheckQueryBean.DataListBean> getData(List<ZaiqianCheckQueryBean.DataListBean> list) {
//        adapter.setmDatas(list);
//        return list;
//    }

    @Override
    public void addListData(List<ZaiqianCheckQueryBean.DataListBean> list) {
        adapter.addAll(list);
    }

    @Override
    public void setData(List<ZaiqianCheckQueryBean.DataListBean> list) {
        adapter.setmDatas(list);
    }
}
