...
import com.wyw.jiangsu.adapter.MedicineProduceActivityAdapter;
import com.wyw.jiangsu.bean.BreedingRecordData;
import com.wyw.jiangsu.interfac.Constance;
import com.wyw.jiangsu.interfac.IBreedingActivity;
import com.wyw.jiangsu.presenter.MedicineProduceActivityPresenter;
...
public class MedicineProduceActivity extends MVPActivity<MedicineProduceActivityPresenter> implements IBreedingActivity, SpringView.OnFreshListener {
    ...
    private MedicineProduceActivityAdapter adapter;
    ...
    @Override
    protected MedicineProduceActivityPresenter createPresenter() {
        return new MedicineProduceActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("兽药生产企业日常检查列表");
...
//        adapter = new QueryRecylerAdapter(this, getDataa());
        adapter = new MedicineProduceActivityAdapter(this, new ArrayList<>(), headerView.getHeaderView());
...
//                bundle.putSerializable(Constance.ACTIVITY_DATA, (Serializable) adapter.getItem(position));
                ...
                bundle.putString("table","Ds_SyscqyjcjlS");
