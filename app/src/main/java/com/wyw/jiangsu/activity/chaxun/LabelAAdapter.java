...
public class LabelAAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private View headerView;
    private Context context;
    private LayoutInflater mLayoutInflater;
    private List<AH_AnimalOrigin.DataListBean> listBean = new ArrayList<>();

    public LabelAAdapter(Context context, List<AH_AnimalOrigin.DataListBean> list, View headerView) {
    ...
    public void setNewData(List<AH_AnimalOrigin.DataListBean> dataListBean) {
...
*/
    ...
    public AH_AnimalOrigin.DataListBean getItem(int position) {
        return listBean.get(position - 1);
    }

    public List<AH_AnimalOrigin.DataListBean> getDates() {
        return listBean;
    }


    public void setmDatas(List<AH_AnimalOrigin.DataListBean> list) {
    ...
    public void addAll(List<AH_AnimalOrigin.DataListBean> list) {
        if (this.listBean == null) {
            this.listBean = list;
        } else {
            this.listBean.addAll(list);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_HEAD.ordinal()) {
            ...
            return new ListviewViewHolder(mLayoutInflater.inflate(R.layout.labela_adapter, parent, false));
        }
    }
