...
import com.wyw.jiangsu.adapter.AnimalTreatActivityPresenter;
import com.wyw.jiangsu.adapter.AnimalTreatAdapter;
...
public class AnimalTreatActivity extends MVPActivity<AnimalTreatActivityPresenter> implements IBreedingActivity, SpringView.OnFreshListener {
    ...
    private AnimalTreatAdapter adapter;
    ...
    @Override
    protected AnimalTreatActivityPresenter createPresenter() {
        return new AnimalTreatActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("动物诊疗场所监督检查记录列表");
...
//        adapter = new QueryRecylerAdapter(this, getDataa());
        adapter = new AnimalTreatAdapter(this, new ArrayList<>(), headerView.getHeaderView());
...
//                bundle.putSerializable(Constance.ACTIVITY_DATA, (Serializable) adapter.getItem(position));
                ...
                bundle.putString("table","Ds_ZlcsjcjlS");
