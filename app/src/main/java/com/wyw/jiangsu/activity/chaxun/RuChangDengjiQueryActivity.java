 ...
 */
public class RuChangDengjiQueryActivity extends MVPActivity<RuChangDengjiQueryActivityPresenter> implements IRuChangDengjiQueryActivity, SpringView.OnFreshListener {
    ...
    private RuChangQueryapter adapter;
    ...
    @Override
    protected RuChangDengjiQueryActivityPresenter createPresenter() {
        return new RuChangDengjiQueryActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("入场查验登记查询列表");
        ...
        headerView = new HeadSearchView(this, mRecyclerView, new HeadSearchView.OnSearchListener() {
            ...
            public void onSearch(String strat, String end, String data) {
                ...
                startStr = strat;
                endStr = end;
                getPresenter().getRuChangDengjiData(data, strat, end);
            }
        });
        adapter = new RuChangQueryapter(this, new ArrayList<>(), headerView.getHeaderView());
    ...
    public void bindListener() {
        ...
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener((recyclerView, position, v) -> {
            if (position != 0) {
                Intent intent = new Intent(this, RuChangDengjiDeilActivity.class);
...
//    @Override
//    public List<RuChangChaYanQueryBean.DataListBean> getData(List<RuChangChaYanQueryBean.DataListBean> list) {
//        adapter.setmDatas(list);
//        return list;
//    }

    @Override
    public void addListData(List<RuChangChaYanQueryBean.DataListBean> list) {
        adapter.addAll(list);
    }

    @Override
    public void setData(List<RuChangChaYanQueryBean.DataListBean> list) {
        adapter.setmDatas(list);
    }
}
