...
import com.wyw.jiangsu.adapter.SlaughterAdapter;
...
import com.wyw.jiangsu.presenter.SlaughterActivityPresenter;
...
public class SlaughterActivity extends MVPActivity<SlaughterActivityPresenter> implements IBreedingActivity, SpringView.OnFreshListener {
    ...
    private SlaughterAdapter adapter;
    ...
    @Override
    protected SlaughterActivityPresenter createPresenter() {
        return new SlaughterActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("生猪屠宰厂(场)日常监督检查记录表列表");
...
//        adapter = new QueryRecylerAdapter(this, getDataa());
        adapter = new SlaughterAdapter(this, new ArrayList<>(), headerView.getHeaderView());
...
//                bundle.putSerializable(Constance.ACTIVITY_DATA, (Serializable) adapter.getItem(position));
                ...
                bundle.putString("table","Ds_SztzcrcS");
