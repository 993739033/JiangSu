 ...
 */
public class AnimalOriginLabelDeilActivity extends MVPActivity {
...
//    EditText etEndOther;
    ...
    @BindView(R.id.SV)
    ScrollView SV;
    private AnimRuZhongYongRecordBean.DataListBean dataListBean;
    private Handler phandler=new Handler(Looper.getMainLooper()){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case 107://关闭对话框
                    Toast.makeText(AnimalOriginLabelDeilActivity.this, "未检测到指定的printshare软件，请先下载", Toast.LENGTH_SHORT).show();
                    break;
                case 108:
                    Toast.makeText(AnimalOriginLabelDeilActivity.this,"请选择图片,找到"+Constance.dirName+"文件夹打印对应的文件",Toast.LENGTH_LONG).show();
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.animal_origin_label_detil_activity);
    ...
    public void bindData() {
        setTitle("乳用、种用动物工作记录单详情");
        Intent intent = getIntent();
        dataListBean = (AnimRuZhongYongRecordBean.DataListBean) intent.getSerializableExtra(Constance.ACTIVITY_DATA);
        ...
        etAnimCount.setText(dataListBean.getAnimalnum() + dataListBean.getQDWDanWei());//数量及单位
        ...
        etStartPlace.setText(dataListBean.getStartaddress() + dataListBean.getStartaddress1());//起运地
        etStartVillage.setText(dataListBean.getStartaddress2() + dataListBean.getStartaddress3()+"乡(镇)"+dataListBean.getStartaddress4());
//        etStartOther.setText(dataListBean.getStartaddress4());
        etEndPlace.setText(dataListBean.getRdddzxx() + dataListBean.getRdddzxx1());//到达地
        etEndVillage.setText(dataListBean.getRdddzxx2() + dataListBean.getRdddzxx3()+"乡(镇)"+dataListBean.getRdddzxx4());
//        etEndOther.setText(dataListBean.getRdddzxx4());
    ...
    private void init() {
        ...
        File file6 = new File(FileUtil.getInstance().getCacheDirPath(), "ruzhong.jpg");
        if (file6.exists()) file6.delete();
        PrintView<AnimRuZhongYongRecordBean.DataListBean> printView6 = new PrintView<>(this, dataListBean);
    ...
    private void saveAndStartPrintShare(String filePath, String fileName) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if(AppUtils.isAvilible(AnimalOriginLabelDeilActivity.this,"com.dynamixsoftware.printershare")){
