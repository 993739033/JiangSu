...
import com.wyw.jiangsu.presenter.CollectionPointActivityPresenter;
 ...
 */
public class CollectionPointActivity extends MVPActivity<CollectionPointActivityPresenter> implements ICollectionPointActivity, SpringView.OnFreshListener {
    ...
    @Override
    protected CollectionPointActivityPresenter createPresenter() {
        return new CollectionPointActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("收集点查询列表");
        ...
        headerView = new HeadSearchView(this, mRecyclerView, new HeadSearchView.OnSearchListener() {
            ...
            public void onSearch(String strat, String end, String data) {
                ...
                startStr = strat;
                endStr = end;
                getPresenter().getCollectionPoint(data, strat, end);
            }
        });
        adapter = new CollectionPointAdapter(this, new ArrayList<>(), headerView.getHeaderView());
    ...
    public void bindListener() {
        ...
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener((recyclerView, position, v) -> {
            if (position != 0) {
                Intent intent = new Intent(this, CollectionPointDealActivity.class);
