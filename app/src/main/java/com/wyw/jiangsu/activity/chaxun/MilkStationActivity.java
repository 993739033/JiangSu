...
import com.wyw.jiangsu.adapter.MilkStationAdapter;
import com.wyw.jiangsu.adapter.MilkStationPresenter;
...
public class MilkStationActivity extends MVPActivity<MilkStationPresenter> implements IBreedingActivity, SpringView.OnFreshListener {
    ...
    private MilkStationAdapter adapter;
    ...
    @Override
    protected MilkStationPresenter createPresenter() {
        return new MilkStationPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("生鲜乳收购站检查表列表");
...
//        adapter = new QueryRecylerAdapter(this, getDataa());
        adapter = new MilkStationAdapter(this, new ArrayList<>(), headerView.getHeaderView());
...
//                bundle.putSerializable(Constance.ACTIVITY_DATA, (Serializable) adapter.getItem(position));
                ...
                bundle.putString("table","SXR_SgjcjlS");
