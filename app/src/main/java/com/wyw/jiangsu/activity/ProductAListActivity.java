...
import com.wyw.jiangsu.interfac.IProductAListActivity;
import com.wyw.jiangsu.presenter.ProductAListActivityPresenter;
 ...
 */
    ...
    public class ProductAListActivity extends MVPActivity<ProductAListActivityPresenter> implements IProductAListActivity, SpringView.OnFreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productsa_layout);
        ButterKnife.bind(this);
    }

    @Override
    protected ProductAListActivityPresenter createPresenter() {
        return new ProductAListActivityPresenter(this);
    }
...
//            startActivityForResult(new Intent(getContext(),AnimProcessListDetilActivity.class), Activity.RESULT_FIRST_USER);
            Intent intent = new Intent(this, ProductAActivity.class);
