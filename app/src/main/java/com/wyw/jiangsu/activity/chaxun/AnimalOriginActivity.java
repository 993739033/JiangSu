...
import com.wyw.jiangsu.presenter.AnimalOriginActivityPresenter;
...
public class AnimalOriginActivity extends MVPActivity<AnimalOriginActivityPresenter> implements IAnimalOriginActivity, SpringView.OnFreshListener {
    ...
    @Override
    protected AnimalOriginActivityPresenter createPresenter() {
        return new AnimalOriginActivityPresenter(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("动物产地工作记录单查询");
        ...
        headerView = new HeadSearchView(this, mRecyclerView, new HeadSearchView.OnSearchListener() {
            ...
            public void onSearch(String strat, String end, String data) {
                ...
                startStr = strat;
                endStr = end;
                getPresenter().getAnimlOriginListData(data, strat, end);
            }
        });
        adapter = new LabelAAdapter(this, new ArrayList<>(), headerView.getHeaderView());
...
//        getPresenter().search();
    ...
    public void bindListener() {
        ...
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener((recyclerView, position, v) -> {
            if (position != 0) {
                Intent intent = new Intent(this, AnimalOriginDetilActivity.class);
...
//        getPresenter().loadmore();
    ...
    @Override
    public void addListData(List<AH_AnimalOrigin.DataListBean> list) {
        adapter.addAll(list);

    }

    @Override
    public void setData(List<AH_AnimalOrigin.DataListBean> list) {
        adapter.setmDatas(list);
    }

//    @Override
//    public List<AH_AnimalOrigin.DataListBean> getData(List<AH_AnimalOrigin.DataListBean> list) {
//        adapter.setmDatas(list);
//        return list;
//    }
}
