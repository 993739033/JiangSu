...
public class JianyichuliQuery extends BaseProxy implements ITime {
    private QuarantineDealListQueryBean.DataListBean bean;
    private TimePresenter timePresenter;
    private String mTime;

    public JianyichuliQuery(Context mContext, Canvas mCacheCanvas, QuarantineDealListQueryBean.DataListBean bean, Bitmap cacheBitmap) {
