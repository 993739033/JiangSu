...
public class JianyichuliQueryPrint extends BaseProxy implements ITime {

    private JianyiChuliTongzhidanListBean.DataListBean bean;
    private TimePresenter timePresenter;
    private String mTime;

    public JianyichuliQueryPrint(Context mContext, Canvas mCacheCanvas, JianyiChuliTongzhidanListBean.DataListBean bean, Bitmap cacheBitmap) {
