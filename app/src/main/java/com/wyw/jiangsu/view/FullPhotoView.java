...
import com.wyw.jiangsu.view.photoview1.PhotoView;
import com.wyw.jiangsu.view.photoview1.PhotoViewAttacher;
...
//    }
    ...
    public void onClick(View v) {
        ...
        //设置photoView单击、双击监听
        mAttacher.setOnDoubleTapListener(new MyOnDoubleTapListener(getContext(), mPopupWindow));
