 ...
 */
public class HarmlessConcentrateProcessListActivityPresenter
        extends BasePresenter<IHarmlessConcentrateProcessListActivity> {
    private String fstId;

    public HarmlessConcentrateProcessListActivityPresenter(IHarmlessConcentrateProcessListActivity view) {
        super(view);
    }

    public void refresh() {
        fstId = "-1";
        addSubscribe(NetClient.getHarmlessList(getUserId(), "SB6", fstId)
