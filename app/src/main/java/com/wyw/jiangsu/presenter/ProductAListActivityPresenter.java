 ...
 */
public class ProductAListActivityPresenter extends BasePresenter<IProductAListActivity>{

    public ProductAListActivityPresenter(IProductAListActivity view) {
        super(view);
    }
    ...
    public void refresh() {
        fstId = "-1";
        addSubscribe(NetClient.getProductA_BBeanListGaiList(getUserId(),"V_AH_AEmbryoQuarantineA",fstId)
                //map里面的是实体类对象
