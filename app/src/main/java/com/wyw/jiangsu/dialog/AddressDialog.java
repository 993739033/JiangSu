...
import com.wyw.jiangsu.adapter.MySimpleAdapter;
import com.wyw.jiangsu.adapter.MyViewPagerAdapter;
...
//                        View.SYSTEM_UI_FLAG_FULLSCREEN |
    ...
    private void initDataAndViews() {
        ...
        defaultProvince = LocalGreenDao.getInstance().queryProvince(1435);
