 ...
 */
public class AnimalTreatActivityPresenter extends BasePresenter<IBreedingActivity> {
    public AnimalTreatActivityPresenter(IBreedingActivity view) {
        super(view);
    }
    ...
    public void getAnimlQuarantineListData(String value, String sdate, String jdate) {
        addSubscribe(NetClient.getAninalTreateData(getUserId(), "Ds_ZlcsjcjlS", "-1", "null", value, sdate, jdate)
    ...
    public void loadData(String value, String sdate, String jdate, String fstid) {
        ...
        addSubscribe(NetClient.getAninalTreateData(getUser().getUSERID() + "", "Ds_ZlcsjcjlS", fstid, "null", value, sdate, jdate)
                .map(animAQueryListBean -> {
                    if (animAQueryListBean.getErrorCode() != 0) {
                        throw new IllegalArgumentException(animAQueryListBean.getErrorMsg());
                    }
