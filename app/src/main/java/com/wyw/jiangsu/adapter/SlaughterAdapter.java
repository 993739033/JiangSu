...
public class SlaughterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SlaughterAdapter(Context context, List<BreedingRecordData.DataListBean> list, View headerView) {
...
*/
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_HEAD.ordinal()) {
            ...
            return new ListviewViewHolder(mLayoutInflater.inflate(R.layout.slaughter_adapter, parent, false));
        }
    }
