...
public class FarmDeclarListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FarmDeclarListAdapter(Context context, List<WuHaiHuaCXbean.DataListBean> list, View headerView) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ListviewViewHolder) {
            ((ListviewViewHolder) holder).tvChuzhuName.setText(list.get(position - 1).getFxzxm());
            ((ListviewViewHolder) holder).tvAdress.setText(list.get(position - 1).getFxxdz());
            ((ListviewViewHolder) holder).tvApplyTime.setText(list.get(position - 1).getFsbrq());//日期
            ((ListviewViewHolder) holder).tvChuliWay.setText(list.get(position - 1).getFclfs());
            ((ListviewViewHolder) holder).tvXiancunlanliang.setText(list.get(position - 1).getFxcll());
            ((ListviewViewHolder) holder).tvYanghzicType.setText(list.get(position - 1).getFyzclx());
            ((ListviewViewHolder) holder).tvErbiaohao.setText(list.get(position - 1).getQDWErBiaoHao());
            ((ListviewViewHolder) holder).tvYikatonghao.setText(list.get(position - 1).getFykth());
            ((ListviewViewHolder) holder).tvShenfenzhenghao.setText(list.get(position - 1).getFsfzh());
            ((ListviewViewHolder) holder).tvSiWanglv.setText(list.get(position - 1).getSwl());
            ((ListviewViewHolder) holder).tvXiangjuJuli.setText(list.get(position - 1).getJl());
            ((ListviewViewHolder) holder).name.setText(list.get(position - 1).getXm());
        }
    }
