...
import com.wyw.jiangsu.bean.SiliaoProduceActivityBean;
...
public class SiliaoProduceActivityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SiliaoProduceActivityAdapter(Context context, List<BreedingRecordData.DataListBean> list, View headerView) {
...
*/
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_HEAD.ordinal()) {
            ...
            return new ListviewViewHolder(mLayoutInflater.inflate(R.layout.siliao_adapter, parent, false));
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ListviewViewHolder) {
            ...
            ((ListviewViewHolder) holder).tvJianyiTime.setText(listBean.get(position - 1).getClsl());
            ((ListviewViewHolder) holder).tvHouzhuName.setText(listBean.get(position - 1).getFLegalPerson());
            ((ListviewViewHolder) holder).tvAnimalType.setText(listBean.get(position - 1).getFPhone());
        }
    }
