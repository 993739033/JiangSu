...
import com.wyw.jiangsu.bean.HarmlesshandleBean;
...
public class HarmlesshandleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HarmlesshandleAdapter(Context context, List<BreedingRecordData.DataListBean> list, View headerView) {
...
*/
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_HEAD.ordinal()) {
            ...
            return new ListviewViewHolder(mLayoutInflater.inflate(R.layout.harmlesshandle_adapter, parent, false));
        }
    }
