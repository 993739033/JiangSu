...
import com.wyw.jiangsu.bean.MedicineProduceActivityPresenterBean;
...
public class MedicineProduceActivityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MedicineProduceActivityAdapter(Context context, List<BreedingRecordData.DataListBean> list, View headerView) {
...
*/
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_HEAD.ordinal()) {
            ...
            return new ListviewViewHolder(mLayoutInflater.inflate(R.layout.medicine_adapter, parent, false));
        }
    }
