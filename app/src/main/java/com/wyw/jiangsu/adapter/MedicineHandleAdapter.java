...
public class MedicineHandleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MedicineHandleAdapter(Context context, List<BreedingRecordData.DataListBean> list, View headerView) {
...
*/
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_HEAD.ordinal()) {
            ...
            return new ListviewViewHolder(mLayoutInflater.inflate(R.layout.medicinehandle_adapter, parent, false));
        }
    }
