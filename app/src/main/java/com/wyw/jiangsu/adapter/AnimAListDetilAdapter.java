...
public class AnimAListDetilAdapter extends BaseQuickAdapter<AnimAProcessListBean.DataListBean> {
    public AnimAListDetilAdapter(List<AnimAProcessListBean.DataListBean> data) {
        super(R.layout.adapter_anim_a_list_detil, data);
    }
