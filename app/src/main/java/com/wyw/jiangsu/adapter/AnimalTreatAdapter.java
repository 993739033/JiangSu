...
import com.wyw.jiangsu.bean.AnimalTreatData;
...
public class AnimalTreatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AnimalTreatAdapter(Context context, List<BreedingRecordData.DataListBean> list, View headerView) {
...
*/
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_HEAD.ordinal()) {
            ...
            return new ListviewViewHolder(mLayoutInflater.inflate(R.layout.treate_adapter, parent, false));
        }
    }
