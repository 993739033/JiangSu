package com.wyw.jiangsu.service.downapk;
...
public class DownService extends Service {
    ...
    public static final String PACKAGE = "com.wyw.jiangsu";
    ...
    private void addDownloadTask(String name, String path, String url) {
        DownloadTask task = new DownloadTask((url).hashCode() + "", NetClient.okHttpClient, this, url,
                path, name, listener);
        tasks.add(task);
