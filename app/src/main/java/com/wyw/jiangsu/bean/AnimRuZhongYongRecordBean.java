...
public class AnimRuZhongYongRecordBean extends BaseArrayObjectEntity<AnimRuZhongYongRecordBean.DataListBean> {

    public static class DataListBean implements Serializable {
        /**
         * FStId : 1
         * FSguidId : e5a88b2c-aa9c-4618-874d-5375577f668d
         * FScTime : 2017-03-09
         * FSuTime : 2017-03-09
         * FSuserId : 1F
         * FSuserName : 超级管理员
         ...
         * FGlid :
         * id : 25
         * recordNo : 苏(320000)1703091517215780
         ...
         * rhzdate : 2017-03-09
         * Gftime : 2017-03-09
         * rqydzxx : 江苏省南京市玄武区a乡(镇)b
         * rdddzxxs : 江苏省南京市玄武区a乡(镇)b
         * rdddzxx : 江苏省
         * rdddzxx1 : 南京市
         * rdddzxx2 : 玄武区
         * rdddzxx3 : a
