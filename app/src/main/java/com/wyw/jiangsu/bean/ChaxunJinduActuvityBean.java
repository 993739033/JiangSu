...
public class ChaxunJinduActuvityBean extends BaseArrayObjectEntity<ChaxunJinduActuvityBean.DataListBean>{

    public static class DataListBean {
        /**
         * FStId : 49
         * dataList1 : [{"ZT":"代申报(彭南祥)"},{"ZT":"收集入库(彭南祥)"}]
         * FSguidId : 97fa939d-0876-4291-87df-88aee976f73e
         * FScTime : 2017-06-02 18:04:47
         * FSuTime : 2017-06-02
         * FSuserId : 107
         * FSuserName : 玄武监管兽医
         * FSunitId : 138
         ...
         * FSunitName : 玄武区街道
         * FSenterpriseId : 10
         * FSenterpriseName : 江苏省南京市玄武区玄武区街道卫生监督所
         * FSaudit : 0
         * FSreviewer :
         * FSmemo1 :
         * FSmemo2 :
