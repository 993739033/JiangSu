...
public class AnimalQuarantineActivityBean extends BaseArrayObjectEntity<AnimalQuarantineActivityBean.DataListBean>{

    public static class DataListBean implements Serializable{
        /**
         * FStId : 67
         * FSguidId : e3a8a173-4556-484b-ac4d-ee3080092799
         * FScTime : 2017-03-27
         * FSuTime : 2017-03-27
         * FSuserId : 234
         * FSuserName : 晏芳
         ...
         * FSm4 :
         * FSm5 :
         * QDWNumber : 苏(320402)1703271531350650
         * QDWCargoOwner : 晏芳
         * QDWPhone : 13638486279
         * QDWXuZhong : 猪
         * QDWXuZhongOne :
         * QDWXuZhongTwo :
         * QDWXuZhongZ : 猪
         ...
         * QDWCunQy : 天宁区新希望养殖场
         * QDWTypeQy : 养殖场
         * QDAddQy : 江苏省常州市天宁区青龙街道乡(镇)天宁区新希望养殖场
         * QDWShengDd : 江苏省
         * QDWShiDd : 南京市
         * QDWXianDd : 玄武区
         * QDWXsqDd :
         ...
         * QDWCunDd : 青龙屠宰场
         * QDWTypeDd : 养殖场
         * QDWAddDd : 江苏省南京市玄武区青龙街道乡(镇)青龙屠宰场
         * QDWErBiaoHao : 320000077777000-019
         * DateQy : 2017-03-27
         * DateQF : 2017-03-27
         * dr : 15
         * XKZH :
